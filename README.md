# genpark-autonomous-background-terminal-test-evaluator-skill
...
> **GenPark AI Agent Skill** -- Background terminal agent running test iterations and auto-fixes (Cursor style)
